...
int main () { // metodo principal
  ...
  */ 
  ...
  switch(processo){ // nasce o pai
          ...
          switch(processo){
            ...
            case 0:
              ...
              switch(processo){
                ...
                default: // voltamos ao processo do primeiro neto (primeiro filho) do pai
            ...
            default: // voltamos para o processo do primeiro filho
          ...
          switch(processo){
            ...
            case 0:
              ...
              switch(processo){
                ...
                default: // voltamos para o processo do segundo neto
            ...
            default: // voltamos para o processo do filho 2
              ...
              switch(processo){
                ...
                default: // ainda no processo do terceiro filho
    ...
    default: // voltamos ao processo do pai
